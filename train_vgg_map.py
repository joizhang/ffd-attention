...
train_real_loader = DataLoader(train_real_data, num_workers=4, batch_size=opt.batch_size_real, shuffle=True,
                               drop_last=True, pin_memory=True)
train_fake_loader = DataLoader(train_fake_data, num_workers=4, batch_size=opt.batch_size_fake, shuffle=True,
                               drop_last=True, pin_memory=True)
...
test_real_loader = DataLoader(test_real_data, num_workers=4, batch_size=opt.batch_size_real, shuffle=True,
                              drop_last=True, pin_memory=True)
test_fake_loader = DataLoader(test_fake_data, num_workers=4, batch_size=opt.batch_size_fake, shuffle=True,
                              drop_last=True, pin_memory=True)
...
def pca_loss(pca_map, mask, label):
    ...
    f_sum = torch.sum(fake_mask.view(fake_mask.shape[0], fake_mask.shape[1] * fake_mask.shape[2] * fake_mask.shape[3]),
                      1)
